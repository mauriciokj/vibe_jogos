...
- Dentro da etapa, existe uma exceção: se a moto chegar a **0% de integridade**, o botão **Reparar moto** permite consertar a moto inscrita pelo preço normal (400 créditos de 0% a 100%). O reparo não libera troca de moto/equipamento, não repõe nitro e preserva os pontos e as corridas já disputadas. A regra também atende campeonatos salvos antes da correção.
- Os rivais usam a mesma exceção de reparo ao chegar a 0%, automaticamente antes da próxima largada. Dano parcial continua entre as corridas. Checkpoints antigos ainda na contagem de largada recebem a correção; não se revive um rival eliminado durante uma corrida já em andamento.
- Com **0%**, a largada fica bloqueada antes de avançar a etapa ou consumir uma corrida. O aviso pede o conserto. Entre **1% e menos de 20%**, há um aviso destacado, mas é permitido correr; dentro da etapa, o reparo só é liberado ao chegar a 0%. Entre etapas, o reparo normal continua disponível com qualquer dano.
...
- Saúde do piloto e cargas de empinar recomeçam por corrida, conforme as regras existentes. Integridade da moto e estoque de nitro não são restaurados automaticamente entre corridas. Durante a corrida, o aviso abaixo de 20% aparece uma vez para evitar repetição.
