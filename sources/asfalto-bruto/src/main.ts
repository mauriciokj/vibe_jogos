...
function draw() { renderer.render(race, screen === 'menu',localId(),finishElapsed,finishOfficer); if (screen !== 'menu' && finishElapsed===null) { updateHUD(); instruments.draw(race,localId()); } }
