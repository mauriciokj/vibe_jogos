...
async function showResult() {
  ...
  if(accounts.cache){
    $('result-modal').innerHTML='<div class="dialog-body"><h2>CONFERINDO A CORRIDA…</h2><p>Confirmando o prêmio e sua garagem.</p></div>';beginResult(race.result.reason==='finish',race.result.place);
