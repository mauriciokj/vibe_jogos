...
export const BIKES: Bike[] = [
  ...
  { id: 'veneno', nitroCapacity: 3, name: 'Veneno 750', class: 'ESPORTIVA', style: 'sport', price: 30000, speed: 73, acceleration: 15, handling: 1.2, armor: .95, color: '#ee734d', tagline: 'Carenagem afiada e motor forte. Acelera muito, exige cuidado no contato.' },
  { id: 'brutal', nitroCapacity: 5, name: 'Brutal 1000', class: 'MUSCLE', style: 'muscle', price: 100000, speed: 78, acceleration: 12.5, handling: .95, armor: 1.4, color: '#b6a1fb', tagline: 'Pneu largo e a maior final. Freie cedo para domar o peso nas curvas.' },
  { id: 'falcao', nitroCapacity: 2, name: 'Falcão 450', class: 'SUPERMOTO', style: 'supermoto', price: 10000, speed: 60, acceleration: 15.6, handling: 1.6, armor: .82, color: '#74dfe9', tagline: 'Alta, estreita e muito ágil. Contorna rápido, perde nas retas e no impacto.' },
