...
export interface RaceResult { reason: 'finish' | 'wrecked' | 'caught' | 'left' | 'timeout'; onFoot?: boolean; secretUnlocked?: boolean; arrestCause?: 'fall' | 'stopped'; place: number; time: number; reward: number; hits: number; falls: number; }
