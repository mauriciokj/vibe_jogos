...
Na campanha, Cobra, Dante e Faísca usam joelheiras: verde na Costa, azul em Serra/Porto/Terra e roxa para os velozes no Vale. O apoio é visível e passa pelo mesmo comando e física do jogador. A IA evita usá-lo na chuva, no acostamento, durante acrobacias e ao corrigir para o lado oposto da curva. O ritmo dos cautelosos subiu ligeiramente; a velocidade máxima dos rivais individuais aumentou cerca de 2–3,3%, ainda abaixo do limite de fábrica. Não há compensação automática de distância nem alteração nas compras ou atributos humanos. As CPUs opcionais do multiplayer também usam a técnica, mantendo as velocidades de fábrica já existentes. Protocolo v11 e save v1 preservados.
...
Na comparação com a versão anterior, a Ferro com joelheira dourada passou de colocação média 1,8 para 2,4, com top 5 nas 15 corridas em ambas as versões; vitórias passaram de cinco para uma. Sem joelheira, a média passou de 4,87 para 5,33 (11 para nove top 5), e todas as corridas foram concluídas. São amostras de um piloto automatizado no seco, sem golpes, não uma previsão dos resultados de jogadores. Artefatos locais em `output/difficulty/`.
