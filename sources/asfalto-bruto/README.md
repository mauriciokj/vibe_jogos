...
- O botão Próxima corrida segue a numeração do menu: Dia → Entardecer → Noite → Chuva, depois Dia da próxima estrada, respeitando as pistas liberadas no individual. No multiplayer, a confirmação de todos mantém a mesma sala e inicia a próxima combinação após cinco segundos. Voltar para a sala permite trocar pista/condição e motos; detalhes em [salas-multiplayer.md](docs/salas-multiplayer.md).
