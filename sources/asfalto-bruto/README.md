...
- O botão Próxima corrida segue a numeração do menu: Dia → Entardecer → Noite → Chuva, depois Dia da próxima estrada, respeitando as pistas liberadas no individual. No multiplayer, prepara a próxima combinação na tela de salas.
